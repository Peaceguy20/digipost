<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="DigiPostPassBook.aspx.cs" Inherits="ViewT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: auto; width:1000px; margin-left:150px">
     ...
     <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
         ...
         ForeColor="#333333" GridLines="None" Width="990px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
         <AlternatingRowStyle BackColor="White" />
         <Columns>
             <asp:CommandField ShowSelectButton="True"  HeaderText="SelectAccount" SelectText="View"/> 
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" SelectCommand="SELECT  [AccountNo], [AccountType], [IntrestRate], [BalanceAmount], [Status] FROM [AccountInfo] WHERE ([MobileNo] = @MobileNo)">
            <SelectParameters>
