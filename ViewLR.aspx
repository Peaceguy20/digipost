<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ViewLR.aspx.cs" Inherits="ViewLR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div style="height: auto; width:1000px; margin-left:150px">
     ...
     <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
         ...
         ForeColor="#333333" GridLines="None" Width="986px" DataKeyNames="RId">
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" SelectCommand="SELECT * FROM [AccountCloseInfo] WHERE ([Status] = @Status)">
         <SelectParameters>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ...
         SelectCommand="SELECT * FROM [LostInfo]"></asp:SqlDataSource>
